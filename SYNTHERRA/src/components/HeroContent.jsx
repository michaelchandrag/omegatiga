  ...
  useEffect(() => {
    ...
    words.forEach(word => {
      if (word.textContent === 'DEFAI') {
        word.classList.add('text-coral-100'); 
      }
    });
    ...
    >
      <div className="w-[835px] flex flex-col items-center justify-start gap-16 shrink-0 max-w-full mq450:gap-4 mq1050:gap-8">
        <div className="self-stretch flex flex-col items-center justify-start gap-4 max-w-full">
          ...
          >
            Syntherra merges AI and blockchain to revolutionize synthetic assets,
            enabling precision minting, secure collateralization, and seamless
            cross-chain integration. Join the DEFAI revolution and shape the future of
