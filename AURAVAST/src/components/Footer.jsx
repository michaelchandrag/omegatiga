...
const Footer = ({ className = "" }) => {
  ...
  return (
    <div
      className={`self-stretch h-[462px] bg-auravast-secondary flex flex-row items-end justify-center py-32 px-5 box-border relative gap-[108px] max-w-full text-center text-xl text-color-white-solid font-jost mq750:h-auto ${className}`}
    >
      {/* Socmed Component */}
      <Socmed github={socialLinks.github_url} twitter={socialLinks.twitter_url} />

      <div className="w-[1201px] !m-[0] absolute top-[-170px] left-[50%] translate-x-[-50%] rounded-3xl bg-black box-border overflow-hidden shrink-0 flex flex-row items-start justify-start py-[93px] px-28 min-h-[334px] max-w-full font-raleway border-solid border-[10px] border-features">
        ...
        <div className="relative flex flex-col items-center justify-center gap-8 w-full">
          ...
          <div className="w-full max-w-[642px] flex flex-col gap-5 justify-center items-center">
            ...
            >
              Be part of the Auravast revolution! Join our waitlist to access the upcoming demo by filling out your email. Experience how Auravast simplifies and enhances your DeFi journey
            </h3>
          </div>
          ...
          >
            ...
            <button
              type="submit"
              className="cursor-pointer [border:none] py-[13px] px-4 bg-auravast-secondary rounded-tl-none rounded-tr-lg rounded-br-lg rounded-bl-none flex flex-row items-center justify-center hover:bg-chocolate"
            >
