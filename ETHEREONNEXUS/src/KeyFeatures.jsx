...
const KeyFeatures = ({ className = "" }) => {
  return (
    <section
      className={`self-stretch bg-color-white-solid flex flex-col items-center justify-start pt-14 px-0 pb-[72px] box-border max-w-full text-center text-5xl text-black font-helvetica-neue mq750:gap-4 mq750:pt-9 mq750:pb-[47px] mq750:box-border ${className}`}
    >
      <div className="max-w-[1280px] w-full flex flex-col items-center justify-start gap-8 mq750:gap-4">
        <div className="flex flex-col items-center justify-start py-0 px-5 box-border gap-4 max-w-full">
